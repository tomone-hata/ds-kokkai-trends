...
|---|---|---|---|---|---|
| EXP-001 | 論点抽出ベースライン（`EXP-001-topic-extraction-baseline`） | PoC | [plan.md](experiments/EXP-001-topic-extraction-baseline/plan.md) | 未作成 | **実施中**（S-4 完了 / 全11ステージ中4。次は S-5 → **RP-B**） |
