...
| 項目 | 内容 |
|---|---|
| 現在のフェーズ | **EXP-001 実施中。S-4 完了（E-2 採用）。次は S-5（分析単位の決定）→ RP-B** |
| 最終更新 | 2026-08-20 |
...
| 実験 | [EXP-001 plan.md](experiments/EXP-001-topic-extraction-baseline/plan.md) | **実施中**（S-4 完了 / 全11ステージ中4） | RP-A 通過。**次のゲートは RP-B（S-5 完了時。S-6 の手前）** |
| アルゴリズム本設計 | | | |
| システム設計 | | | |
| 実装 | | | |
| システム検証 | | | |
